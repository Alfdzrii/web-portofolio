...
const SKILLS = [
  ...
  { name: 'Network Miner', Icon: FaNetworkWired,    color: '#22c55e' },
  { name: 'Linux',         Icon: SiLinux,           color: '#FCC624' },
  { name: 'Burp Suite',    Icon: MdSecurity,        color: '#FF6633' },
  { name: 'Wireshark',     Icon: SiWireshark,       color: '#1679A7' },
  { name: 'Autopsy',       Icon: GiMagnifyingGlass, color: '#9333ea' },
...
function AboutBgOrnaments({ dark }) {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
      ...
      {/* Large rotating square frame — bottom-left */}
      <motion.div
      ...
      >
        <svg width="380" height="380" viewBox="0 0 380 380">
          <rect
            ...
            fill="none" stroke={col} strokeWidth="16"
          />
        </svg>
      </motion.div>
      ...
      {/* Slow oscillating thin horizontal accent line */}
      <motion.div
        className="absolute left-0 right-0 h-px"
        style={{ top: '38%', background: col }}
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <h2
            className={`font-['Plus_Jakarta_Sans',sans-serif] font-black mb-12 uppercase tracking-tighter leading-none
